...
{
  internal class TopRectangleDrawSystem : IDrawSystem, IDrawEntitySystem, IDrawEndSystem
  {
    private readonly SpriteBatch _batch;
    private readonly SpriteBatchExtension _batchExtension;

    public AddonKey Key => KeyHelper.Create<SizeAddon, PositionAddon, ColorAddon, TopAddon>();

    public List<string> Layers => new List<string>();

    public TopRectangleDrawSystem(SpriteBatch batch, SpriteBatchExtension batchExtension)
    {
      _batch = batch;
