...
namespace BlueJay.UI.Factories
{
  public static class ContainerFactory
  {
    ...
    public static IEntity AddContainer(this IServiceProvider provider, Style? style = null, Style? hoverStyle = null, IEntity? parent = null)
    {
    ...
    /// <param name="parent">The parent that should be attached to this parent</param>
    /// <returns>Will return the entity so it can be used as a parent down the line</returns>
    public static IEntity AddContainer(this IServiceProvider provider, IEntity entity, Style? style = null, Style? hoverStyle = null, IEntity? parent = null)
    {
