...
namespace BlueJay.UI.Component.Reactivity
{
  ...
  public interface IReactiveProperty : IObservable<ReactiveUpdateEvent>
  {
    ...
    /// <returns>Will return a disposable that should be destored if the item is removed</returns>
    IDisposable Subscribe(Action<ReactiveUpdateEvent> nextAction, ReactiveUpdateEvent.EventType type, string path = null);
    ...
    void Next(object value, string path = "", ReactiveUpdateEvent.EventType type = ReactiveUpdateEvent.EventType.Update);
  }
