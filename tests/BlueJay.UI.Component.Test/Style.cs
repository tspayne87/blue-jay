...
//       var style = Language.Language.ParseStyle("padding: 5; textColor: 0, 0, 0; font: Default; columnGap: 3", scopes).Item1;
...
//       var style = Language.Language.ParseStyle("padding: {{Padding}}; textColor: 0, 0, 0; font: Default; columnGap: {{ColumnGap}}", scopes).Item1;
